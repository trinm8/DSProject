...
from project.forms.teamsForm import teamsSearchForm
...
def fixtures():
    ...
    if form.validate_on_submit():
        ...
        convertedFixtures.sort(key=lambda x: x[0])
    ...
    if specificMatch.status_code == 200:
        ...
        if matchdate > datetime.datetime.now():
            ...
            if comparingData.status_code == 200:
                ...
                resultObject["historical"] = comparingData.json()["data"]["historicalCombined"]
